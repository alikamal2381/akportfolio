        ...
        <div className="projects-grid">
          ...
          >
            ...
            <CardText>
              <justify>
                ...
                balance and date (Debit or Credit) and also list of all expense
                heads associated with accounts with effect (Debit or Credit).
                Reports include statement, head-wise statement, head total wise
                statement and list of accounts with current balances.
              </justify>
            </CardText>
            <CardActions border>
          ...
          >
            ...
            <CardText>
              ...
              track of all transactions. Software includes voucher type, (BR,
              CR, BP, CP, FT, JV) Complete Accounting package for large
              organaztion.
            </CardText>
            <CardActions border>
              <Button colored>Github</Button>
